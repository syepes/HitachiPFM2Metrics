...
String baseName = 'HitachiPFM2Metrics'
ArrayList classNames = ['com.allthingsmonitoring.hitachi.HitachiPFM2Metrics','com.allthingsmonitoring.utils.MetricClient']
